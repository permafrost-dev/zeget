...
![Eget Demo](https://github.com/zyedidia/blobs/blob/main/eget-demo.gif)
...
```sh
eget permafrost-dev/micro --tag nightly
...
eget -f eget.1 permafrost-dev/eget
eget zachjs/sv2v
...
(requires pandoc). You can also use `eget` to download the man page: `eget -f eget.1 permafrost-dev/eget`.
...
eget permafrost-dev/micro --to ~/.local/bin/micro --sha256 --asset static --asset .tar.gz
```
